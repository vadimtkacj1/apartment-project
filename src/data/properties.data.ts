...
export const PROPERTIES = [
  ...
  { id: 3, image: "/images/hero/rent.webp", title: "Luxury Penthouse with Roof Deck", location: "ראשון לציון", price: "3,200,000", bedrooms: '5', bathrooms: 3, area: 160, status: "Exclusive", category: "sales" },
  ...
  { id: 6, image: "/images/hero/rent.webp", title: "Commercial Warehouse + Offices", location: "בת ים", price: "15,000", bedrooms: '0', bathrooms: 2, area: 250, category: "commercial" },
  ...
  { id: 9, image: "/images/hero/rent.webp", title: "Spacious Duplex with Elevator", location: "ראשון לציון", price: "3,750,000", bedrooms: '6', bathrooms: 3, area: 180, status: "Exclusive", category: "sales" },
  ...
  { id: 12, image: "/images/hero/rent.webp", title: "Office for Rent in Central Location", location: "ראשון לציון", price: "8,500", bedrooms: '0', bathrooms: 2, area: 85, category: "commercial" },
  ...
  { id: 15, image: "/images/hero/rent.webp", title: "Mini Penthouse with Large Roof", location: "ראשון לציון", price: "4,100,000", bedrooms: '5', bathrooms: 3, area: 155, category: "sales" },
  ...
  { id: 18, image: "/images/hero/rent.webp", title: "Commercial Shop on Main Street", location: "ראשון לציון", price: "18,000", bedrooms: '0', bathrooms: 1, area: 120, category: "commercial" },
  ...
  { id: 21, image: "/images/hero/rent.webp", title: "Luxury 6-Room Apartment", location: "ראשון לציון", price: "4,850,000", bedrooms: '6', bathrooms: 3, area: 200, status: "Exclusive", category: "sales" },
  ...
  { id: 24, image: "/images/hero/rent.webp", title: "Luxury Office in Business Tower", location: "ראשון לציון", price: "22,000", bedrooms: '0', bathrooms: 3, area: 180, status: "New", category: "commercial" },
  ...
  { id: 27, image: "/images/hero/rent.webp", title: "8-Room Duplex Penthouse", location: "ראשון לציון", price: "6,200,000", bedrooms: '8', bathrooms: 4, area: 280, status: "Exclusive", category: "sales" },
  ...
  { id: 30, image: "/images/hero/rent.webp", title: "Commercial Complex with Shops", location: "ראשון לציון", price: "35,000", bedrooms: '0', bathrooms: 4, area: 450, status: "Opportunity", category: "commercial" }
];
...
export const filterProperties = (properties: typeof PROPERTIES, selectedCategory: Category, filters: FilterState) => {
  return properties.filter(property => {
    ...
    const propertyRooms = parseFloat(String(property.bedrooms));
    const minRoomsFilter = filters.minRooms ? parseFloat(String(filters.minRooms)) : undefined;
    const maxRoomsFilter = filters.maxRooms ? parseFloat(String(filters.maxRooms)) : undefined;
    if (minRoomsFilter && propertyRooms < minRoomsFilter) return false;
    if (maxRoomsFilter && propertyRooms > maxRoomsFilter) return false;
