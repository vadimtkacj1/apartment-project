...
export default function GuidesSection() {
  return (
    <section dir="rtl" className="w-full py-10 md:py-12 bg-white border-y border-[#1c3664]/10">
          ...
          <ul className="flex flex-wrap justify-center gap-2.5">
            ...
            {featuredGuides.map(({ href, title }) => (
              <li key={href}>
                <Link
                  href={href}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#faf7f2] border border-[#1c3664]/10 text-[#1c3664] font-semibold text-sm hover:border-[#c5a357] hover:bg-white transition-all"
                >
