  ...
  return (
    <div>
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: 16 }}>
        ...
        <Col xs={12} lg={6}><Card><Statistic title="חדשות" value={stats.new} styles={{ content: { color: '#8A6D2F' } }} /></Card></Col>
        <Col xs={12} lg={6}><Card><Statistic title="בטיפול" value={stats.in_progress} styles={{ content: { color: '#1C3664' } }} /></Card></Col>
        <Col xs={12} lg={6}><Card><Statistic title="סגורות" value={stats.closed} styles={{ content: { color: '#3f8600' } }} /></Card></Col>
      </Row>
