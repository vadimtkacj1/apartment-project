        ...
        <article className="article-content">
          <div className="article-body">
            ...
            <section className="article-section">
              ...
              <p>
                <strong>הון עצמי</strong> — לדירה ראשונה הבנק מממן עד 75% משווי הדירה. כלומר, אתם צריכים לפחות 25% מכספכם (חסכונות, קרנות, עזרה מההורים).
              </p>
              <p>
              ...
              <p>
                <strong>עלויות נלוות</strong> — עורך דין, תיווך, שמאי, הובלה ושיפוץ ראשוני. תכננו עוד כ-5% מעל מחיר הדירה. החדשות הטובות: על דירה ראשונה עד התקרה הקבועה בחוק <Link href="/articles/purchase-tax-guide">לא משלמים מס רכישה</Link> כלל.
              </p>
            </section>
