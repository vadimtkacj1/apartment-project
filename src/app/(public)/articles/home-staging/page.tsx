...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'דירה מסודרת, מוארת ומצולמת מקצועית נמכרת מהר יותר ובמחיר גבוה יותר — בשוק שלנו מדובר בתוספת של אחוזים בודדים ועד 5%-10% לעומת אותה דירה מוזנחת. על דירה של 2 מיליון ש"ח, גם 3% הם 60,000 ש"ח — על השקעה של אלפי שקלים בודדים.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'לרוקן ולהאיר. להוציא חפצים אישיים ורהיטים עודפים (הדירה נראית גדולה יותר), לפתוח את כל התריסים ולהדליק את כל האורות. ואז — לתת לצלם מקצועי לעבוד. התמונות הן המודעה: 90% מהקונים מסננים לפיהן.',
      },
    },
  ],
};
