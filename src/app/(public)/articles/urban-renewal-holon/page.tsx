...
export const metadata: Metadata = {
  title: 'התחדשות עירונית בחולון: המתחמים וח/619',
  description: 'אילו מתחמי פינוי-בינוי מקודמים בחולון ומהי תוכנית ח/619? רשימת התוכניות והמתחמים לפי שם ומיקום — ג\'סי כהן, תל גיבורים, קוגל — ומה זה אומר לבעלי דירות.',
  keywords: [
