      ...
      <div className="article-container">
        <article className="article-content">
          <div className="article-body">
            ...
            <Image
              src={getArticle('urban-renewal-holon')!.image}
              alt={getArticle('urban-renewal-holon')!.title}
              width={1200}
              height={630}
            ...
            <section className="article-section">
              ...
              <h3 className="text-2xl font-bold mb-3" style={{ fontFamily: 'var(--font-caramel), cursive, sans-serif' }}>מהי תוכנית ח/619?</h3>
              <div className="definition-block"><p><span className="definition-term">ח/619</span> היא תוכנית ההתחדשות העירונית הכוללת של חולון — תוכנית מסגרת שמסדירה את זכויות הבנייה והעקרונות התכנוניים להתחדשות ברחבי העיר. לצידה פועלת <span className="definition-term">ח/623</span>, תוכנית ההתחדשות העירונית של תל גיבורים. שתיהן מקודמות דרך המינהלת להתחדשות עירונית חולון.</p></div>

              <h3 className="text-2xl font-bold mb-3" style={{ fontFamily: 'var(--font-caramel), cursive, sans-serif' }}>המתחמים והתוכניות בשמם המלא</h3>
              <p>
                אלה התוכניות ומתחמי ההתחדשות המקודמים בחולון, כפי שהם מופיעים אצל המינהלת העירונית. אם הבניין שלכם נמצא באחד מהם — זה משנה את שווי הדירה כבר היום:
              </p>
              <div className="geo-table-wrap">
                <table className="geo-table">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      <td>ח/619 — התחדשות עירונית חולון</td>
                      <td>כלל-עירונית</td>
                      <td>תוכנית מסגרת</td>
                    </tr>
                    <tr>
                      <td>ח/623 — התחדשות עירונית תל גיבורים</td>
                      <td>תל גיבורים</td>
                      <td>תוכנית מסגרת</td>
                    </tr>
                    <tr>
                      <td>תוכנית התחדשות ג׳סי כהן</td>
                      <td>ג׳סי כהן</td>
                      <td>תוכנית שכונתית</td>
                    </tr>
                    <tr>
                      <td>מתחם יוספטל</td>
                      <td>ג׳סי כהן</td>
                    ...
                    <tr>
                      <td>מתחם שדרות קוגל</td>
                      <td>ציר שדרות קוגל</td>
                      <td>פינוי-בינוי</td>
                    </tr>
                    <tr>
                      <td>מתחם דב הוז / המעפילים</td>
                      <td>רחובות דב הוז והמעפילים</td>
                      <td>פינוי-בינוי</td>
                    </tr>
                    <tr>
                      <td>מתחם גולדה – הופיין</td>
                      <td>רחובות גולדה מאיר והופיין</td>
                      <td>פינוי-בינוי</td>
                    </tr>
                  </tbody>
                </table>
              ...
              <p className="source-note">
                מקור: המינהלת להתחדשות עירונית חולון (minhelet-holon.co.il), נבדק ב-6 בספטמבר 2026. מספר יחידות הדיור והשלב התכנוני של כל מתחם משתנים לאורך הזמן — לפני חתימה מול יזם או מכירה, אמתו את הסטטוס העדכני מול המינהלת.
              </p>
            </section>
