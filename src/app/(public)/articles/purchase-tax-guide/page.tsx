  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'רוכשי דירה יחידה נהנים ממדרגת מס של 0% עד לתקרה של כ-2 מיליון ש״ח (התקרה מתעדכנת מדי שנה). מעל התקרה המס עולה בהדרגה: 3.5%, 5%, 8% ו-10% על חלקי השווי הגבוהים יותר.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'מי שבבעלותו כבר דירה משלם מס רכישה מהשקל הראשון: 8% על חלק השווי עד כ-6 מיליון ש״ח ו-10% מעל לכך. לכן חשוב לתכנן את סדר העסקאות — מכירת הדירה הקיימת בתוך התקופה הקבועה בחוק מאפשרת ליהנות ממדרגות דירה יחידה.',
      },
    },
    {
      '@type': 'Question',
