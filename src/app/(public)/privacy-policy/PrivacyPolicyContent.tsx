          ...
          <div className="privacy-body">
            ...
            <section className="privacy-section">
              ...
              <div className="info-item">
                ...
                <p>
                  נתוני גלישה, כתובת IP, עוגיות (Cookies), סוג דפדפן, דפוסי שימוש באתר, חותמות שעה ותאריך.
                </p>
              </div>
              ...
              <div className="info-item">
                ...
                <p>
                  לידיעתכם, האתר עושה שימוש ב"עוגיות" (Cookies), בטכנולוגיות מעקב נוספות ובממשקי סטטיסטיקה ופרסום (כגון Google Analytics, פיקסלים של Meta/פייסבוק וממשקי המרות מתקדמים - CAPI). השימוש נעשה לצורך שמירת תיעוד סטטיסטי אנונימי, ניתוח תנועת הגולשים, בדיקת דפוסי גלישה וזמני שהייה באתר, וזאת כדי לשפר את חווית המשתמש ולהתאים עבורו תכנים שיווקיים (Remarketing).
                </p>
              </div>
            ...
            <section className="privacy-section">
              ...
              <div className="info-item highlight">
                ...
                <p>
                  בעת השארת פרטים באתר, המשתמש מאשר למשרד לשלוח אליו דיוור ישיר, עדכונים, הודעות שיווקיות, מבצעים ודברי פרסומת (לרבות של צדדים שלישיים המשתפים פעולה עם המשרד, כגון יועצי משכנתאות ועו"ד), וזאת באמצעות דוא"ל, מסרונים (SMS), וואטסאפ או אמצעי תקשורת אחרים. המשתמש רשאי בכל עת לבטל את הסכמתו ולהפסיק לקבל מידע זה באמצעות לחיצה על כפתור "הסר" המופיע בתחתית ההודעות, או על ידי פנייה ישירה למשרד. מובהר כי מרגע שהמידע הועבר לאותם צדדים שלישיים (בהסכמת המשתמש), מדיניות הפרטיות של אותם צדדים תחול עליו, והמשרד לא יישא באחריות לאופן שבו הם עושים בו שימוש.
                </p>
              </div>
            </section>
            ...
            <section className="privacy-section">
              <h2>שמירת המידע</h2>
              <p>
                מידע שנמסר למשרד אגב השימוש באתר יישמר במאגרי המידע של המשרד ו/או אצל ספקי שירות מטעמו, לרבות ספקי אחסון, גיבוי וניהול מערכות מידע (CRM). יצוין כי ייתכן והמידע יישמר ויעובד בשרתי ענן או במערכות הממוקמות מחוץ לגבולות מדינת ישראל.
              </p>
              <p>
                המידע אודות המשתמשים יישמר אך ורק למשך הזמן הנדרש למתן שירותי התיווך והייעוץ, או לפרק זמן ארוך יותר במידה והדבר נדרש לצורך עמידה בחובות חוקיות, תיעוד עסקאות נדל"ן וניהול רישומים כנדרש בדין.
              </p>
              <p>
                לצורך הגנה על המידע האישי, המשרד מיישם אמצעי אבטחת מידע מקובלים וסבירים, בהתאם להוראות הדין.
